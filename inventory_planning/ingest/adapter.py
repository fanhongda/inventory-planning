...
def _normalize_material(series: pd.Series) -> pd.Series:
    ...
    extract says `000000000005432106` and the next says `5432106` for the same item, so
    ...
    `6048713.0`, and that joins with nothing — the same silent empty result as the
